...
our kernel, and at production-scale convolutions the gap would keep widening.
...
magnitude more throughput than the FP32 CUDA cores used here --- we
...
--- an order of magnitude above our $1\times10^{-4}$ tolerance --- with
