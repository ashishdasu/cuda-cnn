...
The practical case for GPU-accelerated CNN inference is established by
Krizhevsky, Sutskever, and Hinton~\cite{krizhevsky2012}, whose AlexNet
implementation demonstrated that hand-written CUDA convolution and
fully-connected kernels on a pair of GTX 580s could achieve top-5
accuracy on ImageNet far beyond the then-state-of-the-art; this work
directly motivates the per-kernel CUDA approach taken here.
...
The author thanks Prof.\ Bruce Maxwell of the Khoury College of
Computer Sciences, Northeastern University, for designing and
teaching CS5330 Pattern Recognition and Computer Vision.
...
CS5330 has been among the most formative learning experiences of
the author's undergraduate education, and this project is a direct
product of the curiosity it cultivated.
...
The ground-truth log-softmax outputs used throughout the
correctness harness were generated by the PyTorch framework
\cite{pytorch2019} running the author's Project~5 weights in
eval mode.
...
\texttt{matplotlib}, and Beamer slide templating.
All architectural decisions, kernel designs, correctness
methodology, benchmark measurements, and the analysis in this
paper are the author's own; every line of CUDA was read,
understood, and edited by the author before it was committed.
